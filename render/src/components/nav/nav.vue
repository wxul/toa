<template>
    <ul class="menu">
        <li class="menu-item"><a><i class="fa fa-home fa-fw"></i> 主页</a></li>
        <li class="menu-item has-sub">
            <a href="javascript:;" @click="select(1)" :class="{showactive:collapseall}">二维码</a>
            <collapse-transition>
                <ul class="submenu" v-show="collapseall || curindex==1">
                    <li class="menu-item"><a><i class="fa fa-qrcode fa-fw"></i> 生成</a></li>
                    <li class="menu-item"><a><i class="fa fa-picture-o fa-fw"></i> 解码</a></li>
                </ul>
            </collapse-transition>
        </li>
        <li class="menu-item has-sub">
            ...
            <collapse-transition>
                <ul class="submenu" v-show="collapseall || curindex==2">
                    <li class="menu-item"><a><i class="fa fa-rss-square fa-fw"></i> RSS</a></li>
                    <li class="menu-item"><a><i class="fa fa-envelope fa-fw"></i> 邮箱</a></li>
                </ul>
            </collapse-transition>
        </li>
        <li class="menu-item has-sub">
            ...
            <collapse-transition>
                <ul class="submenu" v-show="collapseall || curindex==3">
                    <li class="menu-item"><a><i class="fa fa-file-text fa-fw"></i> HASH</a></li>
                    <li class="menu-item"><a><i class="fa fa-file-code-o fa-fw"></i> JS压缩</a></li>
                </ul>
            </collapse-transition>
        </li>
        <li class="menu-item has-sub">
            ...
            <collapse-transition>
                <ul class="submenu" v-show="collapseall || curindex==4">
                    <li class="menu-item"><a><i class="fa fa-spinner fa-pulse fa-fw"></i> 嗷！</a></li>
                </ul>
            </collapse-transition>
        </li>
    </ul>
